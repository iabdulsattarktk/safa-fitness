...
const tools = [
  ...
  { slug: "water",        title: "Water Intake",            desc: "Find out how much water you should drink daily based on your body weight and physical activity level.",   img: "/images/facilities/swimming-pool.webp", badge: null,        inputs: "Weight · Activity" },
  { slug: "heart-rate",   title: "Heart Rate Zones",        desc: "Calculate your maximum heart rate and target training zones using the Tanaka formula for your age.",      img: "/images/facilities/run-banner.webp",    badge: null,        inputs: "Age" },
  { slug: "lean-mass",    title: "Lean Body Mass",          desc: "Estimate the weight of your lean tissue (muscle + bone + organs) using the science-based Boer formula.",  img: "/images/trainers/trainer-4.webp",       badge: null,        inputs: "Weight · Height · Gender" },
  { slug: "protein",      title: "Protein Calculator",      desc: "Get your optimal daily protein intake based on your weight and fitness goal — muscle gain, fat loss, or maintenance.", img: "/images/facilities/safa-bar.webp", badge: null, inputs: "Weight · Goal" },
  { slug: "running-pace", title: "Running Pace",            desc: "Calculate your running pace, speed, and estimated calorie burn for any distance and finish time.",        img: "/images/facilities/boxing.webp",        badge: null,        inputs: "Distance · Time" },
  { slug: "waist-height", title: "Waist-Height Ratio",      desc: "Assess your cardiovascular health risk by measuring the ratio between your waist circumference and height.", img: "/images/facilities/lockers.webp",     badge: null,        inputs: "Waist · Height" },
]
