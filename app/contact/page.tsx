...
export default async function ContactPage() {
  ...
  const contactItems = [
    ...
    {
      label: "Phone",
      value: c.contact_phone2,
      href: `tel:${c.contact_phone2.replace(/[^0-9+]/g, "")}`,
      external: false,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
  ...
  const hours = [
    { day: "Monday",    time: c.classes_hours_mon },
    { day: "Tuesday",   time: c.classes_hours_tue },
    { day: "Wednesday", time: c.classes_hours_wed },
    { day: "Thursday",  time: c.classes_hours_thu },
    { day: "Friday",    time: c.classes_hours_fri },
    { day: "Saturday",  time: c.classes_hours_sat },
    { day: "Sunday",    time: c.classes_hours_sun },
  ]

  const visitCards = [
    { img: c.contact_visit_0_img || "/images/facilities/gym.webp",             title: c.contact_visit_0_title, desc: c.contact_visit_0_desc },
    { img: c.contact_visit_1_img || "/images/facilities/services-banner.webp", title: c.contact_visit_1_title, desc: c.contact_visit_1_desc },
    { img: c.contact_visit_2_img || "/images/trainers/kishwar-trainer.webp",   title: c.contact_visit_2_title, desc: c.contact_visit_2_desc },
  ]
  ...
  return (
    <>
      ...
      <section className="relative h-72 sm:h-96 flex items-end overflow-hidden bg-[#0a0a0a]">
        <Image
          src={c.contact_hero_img || "/images/facilities/contact-banner.webp"}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 w-full">
          <p className="text-[#f5a623] text-xs font-bold uppercase tracking-[0.3em] mb-2">{c.contact_hero_badge}</p>
          <h1
            className="text-5xl sm:text-7xl font-bold uppercase text-white leading-none"
            style={{ fontFamily: "var(--font-display)" }}
          >
            {c.contact_hero_h1} <span className="text-[#f5a623]">{c.contact_hero_h1_orange}</span>
          </h1>
        </div>
      </section>
      ...
      <section className="section-padding bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* ── LEFT: Form ── */}
            <div data-reveal>
              <p className="text-[#f5a623] text-xs font-bold uppercase tracking-[0.3em] mb-3">{c.contact_form_tag}</p>
              <h2
                className="text-3xl sm:text-4xl font-bold uppercase text-white mb-2"
                style={{ fontFamily: "var(--font-display)" }}
              >
                {c.contact_form_h2a} <span className="text-[#f5a623]">{c.contact_form_h2b}</span>
              </h2>
              <p className="text-gray-400 text-sm leading-relaxed mb-8">{c.contact_form_desc}</p>
            ...
            <div data-reveal data-delay="2" className="flex flex-col gap-6">
              <div>
                <p className="text-[#f5a623] text-xs font-bold uppercase tracking-[0.3em] mb-3">{c.contact_info_tag}</p>
                <h2
                  className="text-3xl sm:text-4xl font-bold uppercase text-white mb-6"
                  style={{ fontFamily: "var(--font-display)" }}
                >
                  {c.contact_info_h2a} <span className="text-[#f5a623]">{c.contact_info_h2b}</span>
                </h2>
      ...
      <section className="bg-[#0d0d0d]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div data-reveal className="text-center mb-8">
            <p className="text-[#f5a623] text-xs font-bold uppercase tracking-[0.3em] mb-2">{c.contact_map_tag}</p>
            <h2
              className="text-3xl sm:text-4xl font-bold uppercase text-white"
              style={{ fontFamily: "var(--font-display)" }}
            >
              {c.contact_map_h2a} <span className="text-[#f5a623]">{c.contact_map_h2b}</span>
            </h2>
          </div>
              ...
              <div key={item.title} data-reveal data-delay={String(i + 1)} className="group bg-[#141414] border border-[#2a2a2a] hover:border-[#f5a623]/50 rounded-lg overflow-hidden transition-all duration-300">
                <div className="relative h-40 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 px-4 pb-3">
                    <h3 className="text-white font-bold text-base uppercase group-hover:text-[#f5a623] transition-colors" style={{ fontFamily: "var(--font-display)" }}>
                      {item.title}
                    </h3>
                  </div>
                </div>
      ...
      {/* ── CTA ── */}
      <CTABanner
        heading={c.contact_cta_heading}
        subheading={c.contact_cta_sub}
        primaryBtn={{ label: c.contact_cta_btn1, href: waLink }}
        secondaryBtn={{ label: c.contact_cta_btn2, href: "/pricing" }}
        variant="orange"
      />
    </>
  )
